-- [[ Roblox Execution Module ]]
-- [[ Powered by Dyumra Innovations ]]
-- [[ Version: 2.12.0 - Authenticated Interface Edition ]]
...
keyInputBox.Position = UDim2.new(0.5, -140, 0.5, -25)
...
keySubmitBtn.Position = UDim2.new(0.5, -70, 0, 120)
